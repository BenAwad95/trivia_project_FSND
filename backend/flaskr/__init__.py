...
def create_app(test_config=None):
    ...
    def get_questions():
        ...
        if not questions[start:end] and page != 1:
            abort(404)
        return jsonify({
    ...
    def delete_question(question_id):
        ...
        question.delete()
        flash(f"The question '{question_id}' was deleted.")
        return jsonify({
          'success': True,
          'massage': f"The question '{question_id}' was deleted."
        })
    '''
    @TODO:
    ...
    def get_next_question():
        ...
        if category['id'] == 0:
            ...
            questions = [
              question.format() for question in Question.query.filter(
                Question.category.ilike(category['type']))]
            question = {}
            for q in questions:
                if q['id'] not in pre_que_ids:
                    question = q
